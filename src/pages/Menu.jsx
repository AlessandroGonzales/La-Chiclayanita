...
const MENU_DATA = {
  marina: [
    {
      ...
      descripcion:
        "Cubos de pescado fresco marinados en limón de piura, con calamar crujiente.",
  ...
  carnes: [
    ...
    },
    {
      id: "c2",
      nombre: "Seco de Res",
      descripcion: "Carne macerada en culantro y chicha de jora.",
      detalles: "Culantro, Frijol Canario, Salsa Criolla",
      precio: 36.0,
    },
  ],
  entradas: [
    {
      id: "e1",
      nombre: "Causa Limeña",
      descripcion: "Masa de papa amarilla con ají amarillo, rellena de pollo.",
      detalles: "Papa Amarilla, Palta, Huevo, Aceituna",
      precio: 25.0,
    },
  ],
  bebidas: [
    {
      id: "b1",
      nombre: "Pisco Sour",
      descripcion: "Nuestro cóctel bandera, equilibrado y refrescante.",
      detalles: "Pisco Quebranta, Limón, Clara de Huevo",
      precio: 28.0,
    },
  ],
};
...
const categories = [
  ...
  },
  {
    ...
    description: "Pisco Sour, chicha morada...",
...
const Menu = () => {
  ...
  useEffect(() => {
   ...
   const openCategory = (cat) => {
    // Esto crea una nueva entrada en el history: /menu/marina
